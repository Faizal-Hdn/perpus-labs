        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <p class="mb-40">Formulir Pengisian Data Buku Perpustakaan
                        Palembang</p>
                    <form action="{{ route('buku.update', $buku->id_buku) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-10">
                                ...
                                <input type="number" name="kode_buku"
                                    ...
                                    id="validationCustom01" placeholder="Kode Buku" value="{{ $buku->kode_buku }}" autofocus>
                                @error('kode_buku')
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-10">
                                ...
                                <input type="text" name="judul_buku"
                                    ...
                                    id="validationCustom01" placeholder="Judul Buku" value="{{ $buku->nama_buku }}">
                                @error('judul_buku')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-10">
                                ...
                                <select class="form-control custom-select @error('rak') is-invalid @enderror" name="rak">
                                    ...
                                    @foreach ($rak as $data)
                                        <option value="{{ $data->id_rak }}" {{ $data->id_rak == $buku->rak ? 'selected' : '' }}>{{ Str::title($data->jenis_rak) }}</option>
                                    @endforeach
                                </select>
                                @error('rak')
                                    <span class="invalid-feedback">{{ $message }}</span>
                            ...
                            <div class="col-md-2 mb-10">
                                ...
                                <input type="number" name="stok"
                                    ...
                                    id="validationCustom01" value="{{ $buku->stok_buku }}" placeholder="Stok Buku">
                                @error('stok')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-sm">
                                ...
                                <input type="file" id="input-file-now" name="foto" class="dropify" data-default-file="/foto_buku/{{ $buku->foto_buku }}" />
                                @error('foto')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
