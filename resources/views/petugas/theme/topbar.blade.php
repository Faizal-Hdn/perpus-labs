<nav class="navbar navbar-expand-xl navbar-dark fixed-top hk-navbar">
    ...
    <a class="navbar-brand" href="dashboard"> MY LIBRARY
        <!-- <img class="brand-img d-inline-block round-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSW57_AgjjFvryihCz2Rrpo0btBvOIbw12Ltg&s" height="40" alt="brand" /> -->
    </a>
    ...
    <!-- <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-0">
            ...
            <li class="nav-item {{ (request()->is('petugas/laporan*')) ? 'active' : '' }}">
                <a href="{{ route('laporan.index') }}" class="nav-link">Laporan Peminjaman</a>
            </li>
        </ul>
    </div> -->
