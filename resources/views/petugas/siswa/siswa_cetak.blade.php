                ...
                <div class="col-md-6">
                    <div class="card text-white border-success">
                        <div class="card-header bg-success">
                            <div class="row">
                                <div class="col-2">
                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSW57_AgjjFvryihCz2Rrpo0btBvOIbw12Ltg&s" height="90" width="70" alt="">
                                </div>
                                <div class="col-10">
                                    <h5 class="text-center" style="color: white">Kartu Anggota Perpustakaan</h5>
                                    <h5 class="text-center mt-5" style="color: white">UNIVERSITAS SIBER ASIA</h5>
                                    <p class="text-center mt-5">JAKSEL</p>
                                </div>
                            </div>
                        </div>
